...
export function AILearningAnalytics() {
  ...
  const learningData: LearningData = {
    ...
    aiInteractions: {
      totalQuestions: 89,
      topicsDiscussed: ["Redox Reactions", "Calculus Limits", "Cell Biology", "IELTS Writing"],
      avgResponseTime: 1.8,
      satisfactionRate: 94,
    },
  }
  ...
  const knowledgeGraph = [
    {
      subject: "Chemistry",
      topics: [
        { name: "Redox Reactions", mastery: 85, connections: 12, lastStudied: "2 hours ago" },
        { name: "Organic Chemistry", mastery: 72, connections: 8, lastStudied: "1 day ago" },
        { name: "Thermodynamics", mastery: 45, connections: 6, lastStudied: "3 days ago" },
      ],
    },
    {
      subject: "Mathematics",
      topics: [
        { name: "Calculus Limits", mastery: 78, connections: 15, lastStudied: "1 day ago" },
        { name: "Derivatives", mastery: 82, connections: 10, lastStudied: "2 days ago" },
        { name: "Integration", mastery: 35, connections: 4, lastStudied: "1 week ago" },
      ],
    },
    {
      subject: "Biology",
      topics: [
        { name: "Cell Structure", mastery: 90, connections: 14, lastStudied: "3 hours ago" },
        { name: "Metabolism", mastery: 65, connections: 9, lastStudied: "2 days ago" },
        { name: "Genetics", mastery: 40, connections: 5, lastStudied: "5 days ago" },
      ],
    },
  ]

  const learningPatterns = {
    bestStudyTime: "10:00-11:00 AM",
    avgSessionLength: 25,
    preferredDifficulty: "Medium-Hard",
    strongestSubject: "Chemistry",
    improvementNeeded: "Mathematics Integration",
