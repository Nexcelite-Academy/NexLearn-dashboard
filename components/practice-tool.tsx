...
export function PracticeTool() {
  const [questionType, setQuestionType] = useState("Multiple Choice Only")
  const [syllabus, setSyllabus] = useState("NESA")
  const [grade, setGrade] = useState("12")
  const [subject, setSubject] = useState("Chemistry")
  const [difficultyRange, setDifficultyRange] = useState([41, 100])
  const [searchTopic, setSearchTopic] = useState("")
  const [expandedSections, setExpandedSections] = useState<string[]>(["acid-base"])

  const [topics, setTopics] = useState<Topic[]>([
    { id: "acid-base", name: "Acid/Base Reactions", checked: true },
    { id: "chemical-ideas", name: "Applying Chemical Ideas", checked: false },
    { id: "drivers", name: "Drivers of Reactions", checked: false },
    { id: "equilibrium", name: "Equilibrium and Acid Reactions", checked: false },
    { id: "quantitative", name: "Introduction to Quantitative Chemistry", checked: false },
    { id: "organic", name: "Organic Chemistry", checked: false },
    { id: "thermodynamics", name: "Thermodynamics and Kinetics", checked: false },
    { id: "electrochemistry", name: "Electrochemistry", checked: false },
    { id: "molecular", name: "Molecular Structure and Properties", checked: false },
  ])
  ...
  const clearParameters = () => {
    setQuestionType("Multiple Choice Only")
    setSyllabus("")
    setGrade("")
    setSubject("")
  ...
  const getDifficultyDescription = (range: number[]) => {
    const avg = (range[0] + range[1]) / 2
    if (avg <= 40) return "建立理解基礎，透過直接的問題鞏固核心概念"
    if (avg <= 80) return "應用知識解決問題，測試對概念的深層理解"
    return "挑戰複雜問題，以深入和創新的方式呈現概念"
  }
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-slate-900 mb-2">Practice Tool</h2>
                <p className="text-slate-600">這個工具讓你根據難度要求生成練習題目，個人化你的學習體驗</p>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={questionType} onValueChange={setQuestionType}>
                  ...
                  <SelectContent>
                    <SelectItem value="Multiple Choice Only">只有選擇題</SelectItem>
                    <SelectItem value="Short Answer">簡答題</SelectItem>
                    <SelectItem value="Long Answer">長答題</SelectItem>
                    <SelectItem value="Mixed">混合題型</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Select value={syllabus} onValueChange={setSyllabus}>
                    ...
                    <SelectContent>
                      <SelectItem value="NESA">NESA</SelectItem>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-lg bg-green-50 border border-green-200">
                  ...
                  <p className="text-sm text-green-700">建立理解基礎，透過直接的問題鞏固核心概念</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-red-50 border border-red-200">
                  ...
                  <p className="text-sm text-red-700">挑戰複雜問題，以深入和創新的方式呈現概念</p>
                </div>
              </div>
              ...
              <div
                className={`p-4 rounded-lg border-2 ${
                  getDifficultyLevel(difficultyRange) === "Easy"
                    ? "bg-green-50 border-green-300"
                    : getDifficultyLevel(difficultyRange) === "Moderate"
